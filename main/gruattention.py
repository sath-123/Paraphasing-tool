...
Original file is located at
    https://colab.research.google.com/drive/1PQ0JTDpsENwNdqw9hETzq3FKtw267bfu
"""
...
## opening the file and reading hindi paraphases
...
# data is clean so just spliting
'''
...
# finding max length of the sentences
input_maxlength=0
output_maxlength=0
max_length=0
...
def train(model, iterator, optimizer, criterion, clip):
    ...
    if initial > val_loss:
      initial=val_loss
      torch.save(model.state_dict(),'/content/drive/MyDrive/Project_files/gpuattention.pth')
...
# testing for test sentence
sentence= "एक शूज़ जूते में एक शो रैक पर सो रहा है।"
words_index=[]
...
model.load_state_dict(torch.load('/content/drive/MyDrive/Project_files/gpuattention.pth'))
